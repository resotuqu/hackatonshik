...
<header>
    <div class="navbar bg-base-100 shadow-sm justify-between flex flex-row">
        <div class="flex">
...
<main class="py-4 px-6 bg-base-300">
    {{$slot}}
</main>
...
<footer class="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
    ...
    <nav>
        ...
        <a href="/terms-of-use" class="link link-hover">Условия использования</a>
        <a href="/privacy-policy" class="link link-hover">Политика конфиденциальности</a>
