...
<div class="mx-auto max-w-7xl space-y-8">
    ...
    <section class="relative overflow-hidden rounded-3xl border border-base-300 bg-base-200/50 px-5 py-8 sm:px-8 sm:py-10" aria-labelledby="profile-teams-hero-heading">
        ...
        <div class="relative flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div class="min-w-0 space-y-3">
                ...
                <h1 id="profile-teams-hero-heading" class="font-display text-3xl font-black tracking-tight text-base-content sm:text-4xl lg:text-5xl">
            ...
            <div class="flex shrink-0 flex-col gap-3 sm:flex-row sm:items-center">
                <a
                    href="/teams/create"
                    wire:navigate
                    class="btn btn-primary gap-2 shadow-lg shadow-primary/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-base-100 active:scale-[0.98]"
                >
    ...
    <section
        ...
        class="relative overflow-hidden rounded-3xl border border-base-300 bg-base-200/40 px-5 py-6 sm:px-7 sm:py-7"
    ...
    >
        ...
        <div class="relative">
            <h2 id="pending-apps-heading" class="font-display text-lg font-bold tracking-tight text-base-content sm:text-xl">
            ...
            @else
                <ul class="mt-4 space-y-3">
                    @foreach ($this->pendingTeamRoleApplications as $application)
                        ...
                        @endphp
                        <li class="rounded-2xl border border-base-300 bg-base-100/80 p-4 text-sm shadow-sm backdrop-blur-sm">
                            <p>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        @forelse ($this->teams as $team)
            ...
            <article
                ...
                class="group/card flex h-full flex-col overflow-hidden rounded-3xl border border-base-300 bg-base-100 shadow-sm transition duration-300 ease-out motion-safe:animate-card-enter hover:-translate-y-1 hover:border-accent/50 hover:shadow-2xl hover:shadow-accent/15 active:translate-y-0"
            ...
            >
                ...
                <div class="flex min-h-0 flex-1 flex-col gap-4 p-4 sm:p-5">
                    <h2 id="{{ $titleId }}" class="font-display text-2xl font-black leading-tight tracking-tight text-base-content sm:text-3xl">
                        {{ $team->title }}
                    </h2>
                        ...
                        <div class="rounded-2xl border border-base-300 bg-base-200/40 p-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="min-w-0 space-y-1">
                                    ...
                                    <p class="font-display text-base font-bold leading-snug text-base-content sm:text-lg">
                                        {{ $hackaton->title }}
                                    </p>
                    ...
                    <div class="grid grid-cols-2 gap-3 rounded-2xl border border-primary/20 bg-primary/5 p-3">
                        <div class="text-center sm:text-left">
                            <p class="font-display text-2xl font-black tabular-nums text-primary sm:text-3xl">{{ (int) ($team->roles_count ?? $team->roles->count()) }}</p>
                            <p class="text-[11px] font-semibold uppercase tracking-wide text-base-content/60">Ролей</p>
                        </div>
                        <div class="text-center sm:text-left">
                            <p class="font-display text-2xl font-black tabular-nums text-secondary sm:text-3xl">{{ $openSlots }}</p>
                    ...
                    <div class="mt-auto flex flex-col gap-2 pt-1 sm:flex-row sm:flex-wrap">
                        <a
                            ...
                            wire:navigate
                            class="btn btn-primary order-first w-full gap-2 shadow-md shadow-primary/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-base-100 active:scale-[0.98] sm:order-none sm:flex-1"
                        >
                        ...
                        <button
                            type="button"
                            class="btn btn-outline w-full border-base-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-base-100 active:scale-[0.98] sm:flex-1"
                        ...
                        <button
                            type="button"
                            class="btn btn-ghost w-full text-error hover:bg-error/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-error focus-visible:ring-offset-2 focus-visible:ring-offset-base-100 active:scale-[0.98] sm:flex-1"
