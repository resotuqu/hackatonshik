...
>
    ...
    <section class="ui-page-hero relative min-h-[22rem] overflow-hidden motion-safe:animate-card-enter sm:min-h-[26rem]" aria-hidden="true">
        ...
        <div class="relative flex flex-col gap-6 px-5 py-8 sm:px-8 sm:py-10 lg:flex-row lg:items-center lg:gap-10">
            ...
            <div class="skeleton mx-auto aspect-square w-full max-w-[18rem] rounded-3xl sm:max-w-[20rem] lg:max-w-[22rem]"></div>
        </div>
    </section>

    <section class="space-y-5 motion-safe:animate-card-enter" aria-hidden="true">
    ...
    <section class="ui-surface-card p-6 motion-safe:animate-card-enter sm:p-8" aria-hidden="true">
