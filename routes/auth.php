...
Route::get('/auth/yandex/redirect', [SocialAuthController::class, 'redirect'])->defaults('provider', 'yandex')->middleware('throttle:login')->name('auth.yandex.redirect');
Route::get('/auth/yandex/callback', [SocialAuthController::class, 'callback'])->defaults('provider', 'yandex')->middleware('throttle:login')->name('auth.yandex.callback');
...
Route::get('/auth/vk/redirect', [SocialAuthController::class, 'vkRedirect'])->middleware('throttle:login')->name('auth.vk.redirect');
Route::get('/auth/vk/callback', [SocialAuthController::class, 'vkCallback'])->middleware('throttle:login')->name('auth.vk.callback');
